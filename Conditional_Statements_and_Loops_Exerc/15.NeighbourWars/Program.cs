    ...
    class NeighbourWars
    {
        static void Main(string[] args)
        {
            ...
            while (isAnyoneAlive)
            {
                ...
                {
                    Console.WriteLine("{0} won in {1}th round.", attacker, attackCounter);
                    isAnyoneAlive = false;
                }
                else
                {
                    ...
                    Console.WriteLine("{0} used {1} and reduced {2} to {3} health.", attacker, attackName,attacked, attackedHealth);
                }
            }
        }
    }
